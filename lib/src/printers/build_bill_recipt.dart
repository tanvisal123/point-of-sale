...
class BuildBillRecipt extends StatelessWidget {
        ...
        child: Column(
          ...
          children: [
            ...
            Column(
              ...
              //     //   Expanded(
              //     //       flex: 4,
              //     //       child: _customerText("coca-cola(unit)",
              //     //           fontWeight: FontWeight.bold)),
              //     //   Expanded(
              //     //     child: _customerText("3", fontWeight: FontWeight.bold),
              //     //   ),
              //     //   Expanded(
              //     //       flex: 2,
              //     //       child: _customerText("100", fontWeight: FontWeight.bold)),
              //     //   Expanded(
              //     //       child: _customerText(_f.format(0.0),
              //     //           fontWeight: FontWeight.bold)),
              //     //   Expanded(
              //     //       flex: 2,
              //     //       child: _customerText(_f.format(300),
              //     //           fontWeight: FontWeight.bold)),
              //     // ],
              //   )
              // ],
              ...
              children: [
                Expanded(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.end,
                    children: [
                      _customerText("total Qty", fontWeight: FontWeight.bold),
                ...
                Expanded(
                  child: Container(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.end,
                      children: [
                        // _customerText("100.00", fontWeight: FontWeight.bold),
                        // _customerText("0.00", fontWeight: FontWeight.bold),
                        // _customerText("300.00", fontWeight: FontWeight.bold),
